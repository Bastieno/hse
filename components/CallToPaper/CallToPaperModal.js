...
import StyledCallToPaperModal from './StyledCallToPaperModal';
...
const CallToPaperModal = () => {
    const [isCallToPaperVisible, setIsCallToPaperVisible] = useState(true);
    ...
    return (
        <StyledCallToPaperModal
            title="About the Conference"
            visible={isCallToPaperVisible}
            onOk={() => setIsCallToPaperVisible(false)}
            onCancel={() => setIsCallToPaperVisible(false)}
            okButtonProps={{ style: dialogBoxStyles.okButton }}
            cancelButtonProps={{ style: dialogBoxStyles.cancelButton }}
            style={{ zIndex: 10000 }}
            width="100%"
            closable={true}
            wrapClassName="container-940--hide-scroll"
            maskStyle={{ backgroundColor: 'rgba(0, 0, 0, 0.85)' }}
        >
            <ContentWrapper>
                <div>
                    <p>
                        The first in the series of the above International HSE Conference on the petroleum industry and the Nigerian environment was organized in 1979.
                        The Conference which is hosted in different cities of the country has been attracting an ever-increasing and diverse audience due to the interdisciplinary nature of HSE.
                    </p>
                    <p>
                        The 19th edition of the conference is scheduled to hold in <span className="blue-text bold-text">November 2021</span> at the <span className="red-text bold-text">International Conference Centre (ICC) Abuja</span> and the theme of the Conference is
                        <span className="italic-text bold-text red-text">{' '}“Promoting Occupational Health Best Practices towards Enhanced Productivity in the Oil & Gas Industry”</span>
                    </p>
                </div>
                <div>
                    ...
                    <p>
                        Interested participants should kindly register electronically
                        via{' '}
...
export default CallToPaperModal;
